...
import com.ishirlitton.fingerid.LogUtil;
...
public class CryptoObjectHelper {
    static final String KEY_NAME = "com.towatt.charge.towatt";//密码名字
    ...
    public CryptoObjectHelper() throws Exception {
        ...
        _keystore.load(null);
        LogUtil.e("密码库", _keystore.toString());
    }
    ...
    Key GetKey() throws Exception {
        ...
        LogUtil.e("指纹码", secretKey.toString());
        return secretKey;
    }
